...
$hasilorde_detailr=json_decode($order_detail);
...
$total_bayar=$hasilorder->totalbayar;
...
$sql = "insert into tbl_order(trans_id, email, tgl_order, subtotal, ongkir, total_bayar,
alamat_kirim, kota, provinsi, lamakirim, kodepos, metodebayar, buktibayar, status) values 
('$id', '$email', '$tgl_order', '$subtotal', '$ongkir', '$total_bayar', 
'$alamat_kirim', '$kota', '$provinsi', '$lamakirim', 
'$kodepos', '$metodebayar', '$buktibayar', '$status')";
